...
function Dashboard({ state, onNavigate }: { state: AppState; onNavigate: (view: View) => void }) {
  ...
  return <>
    ...
    <section className="card overview-trend-card"><div className="card-header"><div><h2>按月资金趋势</h2><p className="footnote">灵活资金与非灵活资金按月连续堆积展示；悬停图形可查看资金预测合计与明细。</p></div></div><CashSafetyChart points={points} /></section>
